...
(cl:in-package trackbotCeral-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <trackbotMotors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'trackbotMotors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name trackbotCeral-msg:<trackbotMotors> is deprecated: use trackbotCeral-msg:trackbotMotors instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <trackbotMotors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trackbotCeral-msg:header-val is deprecated.  Use trackbotCeral-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'rightMotor-val :lambda-list '(m))
(cl:defmethod rightMotor-val ((m <trackbotMotors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trackbotCeral-msg:rightMotor-val is deprecated.  Use trackbotCeral-msg:rightMotor instead.")
  (rightMotor m))

(cl:ensure-generic-function 'leftMotor-val :lambda-list '(m))
(cl:defmethod leftMotor-val ((m <trackbotMotors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trackbotCeral-msg:leftMotor-val is deprecated.  Use trackbotCeral-msg:leftMotor instead.")
  (leftMotor m))
